      ...
      {Array.from({ length: total }).map((_, i) => (
        <div key={i} style={{ display: "flex", alignItems: "center" }}>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "6px" }}>
            <motion.div
              animate={{
                backgroundColor: i < current ? "#111" : i === current ? "#111" : "#e5e7eb",
              }}
              style={{
          ...
          {i < total - 1 && (
            <div style={{
              width: "80px", height: "1.5px", margin: "0 4px",
              marginBottom: "18px",
              backgroundColor: i < current ? "#111" : "#e5e7eb",
...
export default function SubirPrueba() {
  ...
  const stepLabels = ["Colegio y año", "Materia", "Archivo"];
      ...
      <div style={{ minHeight: "100vh", backgroundColor: "#fff", fontFamily: "'DM Sans', sans-serif", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        >
          ...
          <p style={{ fontSize: "14px", color: "#6b7280", lineHeight: 1.7, marginBottom: "32px" }}>
            Tu prueba está siendo revisada. Una vez aprobada va a aparecer en la plataforma.
          </p>
          <div style={{ display: "flex", gap: "10px", justifyContent: "center" }}>
            <motion.button
              ...
              style={{
                backgroundColor: "#111", color: "#fff", fontWeight: 700,
                fontSize: "14px", padding: "11px 24px", borderRadius: "10px",
            ...
            <motion.button
              ...
              onClick={() => { setSubmitted(false); setStep(0); setForm({ colegio: "", año: "", materia: "", profesor: "", tema: "", archivo: null, notas: "" }); }}
              style={{
                backgroundColor: "#fff", color: "#111", fontWeight: 600,
                fontSize: "14px", padding: "11px 24px", borderRadius: "10px",
      ...
      <div style={{ maxWidth: "600px", margin: "0 auto", padding: "52px 24px" }}>
        ...
        <div style={{ marginBottom: "40px" }}>
          ...
          <p style={{ fontSize: "14px", color: "#9ca3af" }}>
            Completá los datos para que otros estudiantes puedan encontrarla
          </p>
        </div>
            ...
            {step === 0 && (
              ...
              >
                <Field label="Colegio" required>
                  <select
                    value={form.colegio}
                    onChange={(e) => { set("colegio", e.target.value); set("materia", ""); }}
                    style={selectStyle}
              ...
              >
                {sinMaterias ? (
                  <div style={{
                    ...
                    ⚠️ Todavía no tenemos las materias cargadas para <strong>{form.colegio}</strong>. Podés continuar igual y agregar el nombre en el campo de notas.
                  </div>
                ) : (
                ...
                <Field label="Tema">
                  <input
                    ...
                    placeholder="Ej: Integrales, Segunda Guerra Mundial..."
                    style={inputStyle}
                    onFocus={(e) => { e.currentTarget.style.borderColor = "#111"; e.currentTarget.style.backgroundColor = "#fff"; }}
                    onBlur={(e) => { e.currentTarget.style.borderColor = "#e5e7eb"; e.currentTarget.style.backgroundColor = "#f9fafb"; }}
                  />
            ...
            {step === 2 && (
              ...
              >
                <Field label="Archivo de la prueba" required>
                  ...
                  >
                    <span style={{ fontSize: "32px" }}>{form.archivo ? "📄" : "☁️"}</span>
                ...
                <div style={{ backgroundColor: "#f9fafb", borderRadius: "12px", padding: "16px 18px", border: "1px solid #f3f4f6" }}>
                  <p style={{ fontSize: "11px", fontWeight: 700, color: "#9ca3af", marginBottom: "10px", textTransform: "uppercase", letterSpacing: "0.5px" }}>
                    Resumen
                  </p>
                  {[
                    ...
                    <div key={row.label} style={{ display: "flex", justifyContent: "space-between", padding: "5px 0", borderBottom: "1px solid #f3f4f6" }}>
                      ...
                      <span style={{ fontSize: "13px", fontWeight: 600, color: "#111" }}>{row.val}</span>
                    </div>
                  ))}
                </div>
              </motion.div>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", gap: "10px" }}>
          ...
          {step < 2 ? (
            ...
            <motion.button
              whileTap={{ scale: stepValid[2] ? 0.98 : 1 }}
              onClick={() => stepValid[2] && setSubmitted(true)}
              style={{
                padding: "11px 28px", borderRadius: "10px",
                backgroundColor: stepValid[2] ? "#111" : "#e5e7eb",
                color: stepValid[2] ? "#fff" : "#9ca3af",
                fontWeight: 700, fontSize: "14px",
                border: "none",
                borderBottom: stepValid[2] ? "3px solid #4f46e5" : "none",
