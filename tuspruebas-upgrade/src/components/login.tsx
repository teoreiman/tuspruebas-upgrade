      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "60px", backgroundColor: "#fff", position: "relative" }}>
        ...
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.45 }} style={{ width: "100%", maxWidth: "400px" }}>
          ...
          <div style={{ marginBottom: "36px" }}>
            <h2 style={{ fontSize: "26px", fontWeight: 900, color: "#111", fontFamily: "'Syne', sans-serif", marginBottom: "6px" }}>Bienvenido de vuelta</h2>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "7px" }}>
                ...
                <button type="button" style={{ fontSize: "12px", color: "#9ca3af", background: "none", border: "none", cursor: "pointer" }}>¿Olvidaste tu contraseña?</button>
              </div>
